...
public class TipoEnfermedad {
    ...
    public int getIdTipoEnfermedad(){return idTipoEnfermedad;}
    public void setIdTipoEnfermedad(int idTipoEnfermedad){this.idTipoEnfermedad = idTipoEnfermedad;}

    public String getNombreTipoEnfermedad(){return  nombreTipoEnfermedad;}
    public void setNombreTipoEnfermedad(int nombreTipoEnfermedad){this.nombreTipoEnfermedad = nombreTipoEnfermedad;}

    public String getTipoTipoEnfermedad(){return  tipoTipoEnfermedad;}
    public void setTipoTipoEnfermedad(int tipoTipoEnfermedad){this.tipoTipoEnfermedad = tipoTipoEnfermedad;}
