...
@Override
    public void insert(Tiposuscrip tiposuscrip){sR.save(tiposuscrip);}
@Override
public List<Tiposuscrip> list(){return sR.findAll();}
@Override
public void delete(int idTiposuscrip){sR.deleteById(idTiposuscrip);}
@Override
public Tiposuscrip listId(int IdTiposuscrip){return sR.findById(IdTiposuscrip).orElse(new Tiposuscrip());}
